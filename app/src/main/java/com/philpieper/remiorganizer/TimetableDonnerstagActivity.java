...
public class TimetableDonnerstagActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donnerstag_timetable);
        ...
        //Weiter Button
        ivToFreitag = findViewById(R.id.ivToFreitag);
        ivToFreitag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TimetableDonnerstagActivity.this, TimetableFreitagActivity.class);
