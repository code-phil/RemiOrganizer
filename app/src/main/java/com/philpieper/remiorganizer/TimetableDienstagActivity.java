...
public class TimetableDienstagActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dienstag_timetable);
        ...
        //Weiter Button
        ivToMittwoch = findViewById(R.id.ivToMittwoch);
        ivToMittwoch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TimetableDienstagActivity.this, TimetableMittwochActivity.class);
